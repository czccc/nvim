...
M.packers = {
  {
    ...
    opt = true,
    config = function()
      require("plugins.lang.markdown").setup_markdown_preview()
    end,
  },
  -- {
  ...
  --   ft = "markdown",
  --   config = function()
  --     require("plugins.lang.markdown").setup_vim_markdown()
  --   end,
  -- },
  {
    ...
    ft = "markdown",
    config = function()
      require("plugins.lang.markdown").setup_vim_markdown_toc()
    end,
  },
}
