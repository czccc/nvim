...
function M.toggle_popup(ft)
  ...
  local function set_syntax_hl()
    ...
    tbl_set_highlight(require("plugins.lsp.null-ls.formatters").list_registered(ft), "LvimInfoIdentifier")
    tbl_set_highlight(require("plugins.lsp.null-ls.linters").list_registered(ft), "LvimInfoIdentifier")
